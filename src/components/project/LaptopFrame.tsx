...
const LaptopFrame: React.FC<LaptopFrameProps> = ({ imageSrc, altText }) => {
    return (
        <div className=" md:h-[346px] md:w-[700px] h-[217px] w-[350px] sm:h-[200px] sm:w-[500px] my-auto rounded-t-3xl mt-0 overflow-hidden " >
            <div className="h-full flex flex-col rounded-t-3xl ">
                ...
                <img src={imageSrc} className=" object-covermin-h-0 m-[2px] md:mx-[57px] sm:mx-[42px] mx-[28px] rounded-t-xl overflow-clip pb-4" alt={altText} />
            </div>
        </div>
    )
}
